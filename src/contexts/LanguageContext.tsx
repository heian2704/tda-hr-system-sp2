...
const allAppTranslations: AllTranslationsCollection = {
  English: {
    ...
    dashboard: {
      ...
      title: "Dashboard",
      totalEmployees: "Total Employees",
      onBoardEmployeesByMonth: "Monthly New Employees",
      ...
      activityLog: "Latest Activity Log",
  ...
  Burmese: {
    ...
    dashboard: {
      ...
      onBoardEmployeesByMonth: "ဝန်ထမ်းအသစ်ဝင်ရောက်မှု",
      ...
      activityLog: "နောက်ဆုံးလုပ်ဆောင်ချက်မှတ်တမ်း",
